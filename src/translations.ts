...
export const translations = {
  hu: {
    ...
    hero: {
      ...
      projectTitle: 'Modern Családi Ház, Budapest',
      satisfaction: 'Vevőelégedettség',
    },
    services: {
      badge: 'Mivel foglalkozunk?',
      title: 'Szolgáltatásaink {gradient}',
      gradient: 'Spektruma',
      ...
      ctaButton: 'Szakértői Konzultáció',
    },
    about: {
      badge: 'Rólunk',
      ...
      values: [
        ...
        {
          title: 'Értékeink',
          description: 'Őszinteség, megbízhatóság és a legmagasabb szakmai színvonal minden projektben.',
        },
        {
          title: 'Innováció',
          description: 'Folyamatosan kutatjuk a legújabb anyagokat és technológiákat a legjobb eredményért.',
        },
      ],
    },
    portfolio: {
      badge: 'Munkáink',
      title: 'Referencia {gradient}',
      gradient: 'Galéria',
      description: 'Büszkék vagyunk az elvégzett munkáinkra. Tekintse meg legutóbbi projektjeinket, ahol a minőség és a precizitás találkozik.',
      all: 'Összes',
    ...
    contact: {
      badge: 'Kapcsolat',
      title: 'Kérjen {gradient} Ajánlatot!',
      gradient: 'Ingyenes',
      desc: 'Készen állunk, hogy segítsünk tetője felújításában vagy javításában. Vegye fel velünk a kapcsolatot még ma!',
  ...
  en: {
    ...
    hero: {
      ...
      projectTitle: 'Modern Family House, Budapest',
      satisfaction: 'Customer Satisfaction',
    },
    services: {
      badge: 'What we do?',
      title: 'Our {gradient} of Services',
      gradient: 'Spectrum',
      ...
      ctaDesc: 'We are also available for unique needs. Request a free consultation!',
      ctaButton: 'Expert Consultation',
    },
    about: {
      badge: 'About Us',
      ...
      values: [
        ...
        {
          title: 'Our Values',
          description: 'Honesty, reliability, and the highest professional standards in every project.',
        },
        {
          title: 'Innovation',
          description: 'We constantly research the latest materials and technologies for the best results.',
        },
      ],
    },
    portfolio: {
      badge: 'Our Work',
      title: 'Reference {gradient}',
      gradient: 'Gallery',
      description: 'We are proud of our completed works. Take a look at our recent projects where quality and precision meet.',
      all: 'All',
    ...
    contact: {
      badge: 'Contact',
      title: 'Get a {gradient} Quote!',
      gradient: 'Free',
      desc: 'We are ready to help with your roof renovation or repair. Contact us today!',
